...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optional: store admin info locally (e.g., name) if needed
      ...
      <div className="bg-white shadow-2xl rounded-2xl w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 text-white font-semibold rounded-lg mt-2 transition-all duration-300 ${
              loading ? "bg-gray-500 cursor-not-allowed" : "bg-[#003848] hover:bg-[#002233]"
            }`}
          >
